...
import anushka.annu.mandi.adapter.CategoryAdapter;
import anushka.annu.mandi.adapter.DiscountedProductAdapter;
import anushka.annu.mandi.adapter.RecentlyViewedAdapter;
import anushka.annu.mandi.model.Category;
import anushka.annu.mandi.model.DiscountedProducts;
import anushka.annu.mandi.model.RecentlyViewed;

import java.util.ArrayList;
import java.util.List;
import java.util.ListIterator;

import static anushka.annu.mandi.R.drawable.*;
